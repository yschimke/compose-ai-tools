...
| Render mode | a11y (opt-in via `previewExtensions.a11y { enableAllChecks() }` or `-PcomposePreview.previewExtensions.a11y.enableAllChecks=true`; `LocalInspectionMode = false` either way) |
| Cost | low |
