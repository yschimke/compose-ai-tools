 ...
 * UTF-8 JSON over the daemon subprocess's stdin/stdout — kept here so the tests stay free of any VS
 * Code extension dependency. Reads are bounded by a wall-clock timeout (the blocking
