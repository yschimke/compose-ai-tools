...
abstract class GenerateRobolectricPropertiesTask : DefaultTask() {
    ...
    fun generate() {
        ...
        // in this package. Keeps `Font(GoogleFont(...), provider)` rendering
        // correctly under Robolectric without the consumer having to add
        // `@Config(shadows = [...])` to their tests. See [ShadowFontsContractCompat].
