...
## [0.8.0](https://github.com/yschimke/compose-ai-tools/compare/v0.9.0...v0.8.0) (2026-04-30)
...
* **cli:** add install.sh bootstrap and `compose-preview doctor` precheck ([#18](https://github.com/yschimke/compose-ai-tools/issues/18)) ([307e65b](https://github.com/yschimke/compose-ai-tools/commit/307e65bd27e998cba28d8caab0d30aa5605e601f))
...
* **previews:** add Tiles Preview support ([a61095c](https://github.com/yschimke/compose-ai-tools/commit/a61095cacc3165ae868a93f39acabfba63b7c2ba))
* **previews:** add Wear Tiles Preview support ([e32cf9c](https://github.com/yschimke/compose-ai-tools/commit/e32cf9cb6709f940c6db1b56da606b779fbfd464))
...
* **renderer:** switch to roborazzi-compose capture ([2cc9b73](https://github.com/yschimke/compose-ai-tools/commit/2cc9b736c4548b28083ecc8d2eb4d0950e95d649))
...
* **renderer:** use compose rule and roborazzi ([cddc0a7](https://github.com/yschimke/compose-ai-tools/commit/cddc0a7009b612f18ea69a4445b587f74542b5e1))
...
* **cli:** keep .tar.gz extension without leaking it into dist root ([#19](https://github.com/yschimke/compose-ai-tools/issues/19)) ([30841fb](https://github.com/yschimke/compose-ai-tools/commit/30841fbc403f3d52dd7f10bdaf48168c00454fb1))
...
* codebase review bug fixes, hardening, and doc sync ([fa5a018](https://github.com/yschimke/compose-ai-tools/commit/fa5a0189f16738df4a5983dc81acce236056911f))
* codebase review bug fixes, hardening, and doc sync ([eddf005](https://github.com/yschimke/compose-ai-tools/commit/eddf005fb18545d27bb0c4570b8d1a1fbf9602b9))
...
* **plugin:** append consumer test classes to classpath in renderPreviews ([#37](https://github.com/yschimke/compose-ai-tools/issues/37)) ([b935bec](https://github.com/yschimke/compose-ai-tools/commit/b935becc307a9689455118371fc1af0bc5d2826f))
...
* **plugin:** fallback to consumer test classes in renderPreviews ([#33](https://github.com/yschimke/compose-ai-tools/issues/33)) ([8ae05bb](https://github.com/yschimke/compose-ai-tools/commit/8ae05bbdb4ca500ba4d6ec696c57e48d14b2b92f))
...
* **tiles:** put AGP's unit_test_config_directory on renderPreviews classpath ([0ff2555](https://github.com/yschimke/compose-ai-tools/commit/0ff255558cdcbd6c8b64631c791e0ffd656ed329))
* **tiles:** put unit_test_config_directory on renderPreviews classpath ([67704d5](https://github.com/yschimke/compose-ai-tools/commit/67704d5db15f1a6116ee78ad34749fbe9260706f))
...
* **sample:** fix preview slowness and OOM ([#14](https://github.com/yschimke/compose-ai-tools/issues/14)) ([fff2565](https://github.com/yschimke/compose-ai-tools/commit/fff25658039267c71946274b9a99753fbd7d7e73))
