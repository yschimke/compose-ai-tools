...
## [0.17.0](https://github.com/yschimke/compose-ai-tools/compare/v0.16.11...v0.17.0) (2026-07-01)
...
* **a11y:** render overlays + legends across all sample modules, incl. CMP/desktop ([#1575](https://github.com/yschimke/compose-ai-tools/issues/1575)) ([5f0315f](https://github.com/yschimke/compose-ai-tools/commit/5f0315f22894b23006dc2e6671976f4c1efb855e))
...
* **daemon-bench:** drive stage-1/stage-2 compile legs + CI smoke ([#1586](https://github.com/yschimke/compose-ai-tools/issues/1586)) ([#1615](https://github.com/yschimke/compose-ai-tools/issues/1615)) ([bbffe6c](https://github.com/yschimke/compose-ai-tools/commit/bbffe6cf3ea050b4f37c49034e3766a56d8bf6da))
...
* **daemon:** complete stage-2 in-process compile (BTA) behind experimental flag ([#1587](https://github.com/yschimke/compose-ai-tools/issues/1587)) ([b840b74](https://github.com/yschimke/compose-ai-tools/commit/b840b74f15d9b9b2ffac3bebfadec038810001bb))
...
* **daemon:** produce @ScrollingPreview artefacts via data/fetch ([#1579](https://github.com/yschimke/compose-ai-tools/issues/1579)) ([7e60534](https://github.com/yschimke/compose-ai-tools/commit/7e605349b87c23f75182402c537866f439529e04))
...
* **daemon:** wire desktop scroll scenario runner (render/scroll/long + gif) ([#1609](https://github.com/yschimke/compose-ai-tools/issues/1609)) ([4e0a76d](https://github.com/yschimke/compose-ai-tools/commit/4e0a76d011d00d516b539f687ee1c56a256f29c8))
...
* IP-safe cross-project metadata service for preview tooling detection ([#1580](https://github.com/yschimke/compose-ai-tools/issues/1580)) ([abcd6df](https://github.com/yschimke/compose-ai-tools/commit/abcd6dfd746b94f20a38f8318fe2b5c92896dd80))
...
* **mcp:** accept and validate override-extension fields in render_preview ([#1611](https://github.com/yschimke/compose-ai-tools/issues/1611)) ([b96a4d7](https://github.com/yschimke/compose-ai-tools/commit/b96a4d763c77843585e97898808913c1b4e30c2e))
...
* **permissions:** cross-classloader data/fetch readback for compose/permissions queries ([#1582](https://github.com/yschimke/compose-ai-tools/issues/1582)) ([28b6d0a](https://github.com/yschimke/compose-ai-tools/commit/28b6d0a1f1978858fac352198537dee4d452cd69))
...
* **plugin:** make ValidatePreviewToolingPresent opt-in ([#1620](https://github.com/yschimke/compose-ai-tools/issues/1620)) ([a90bda6](https://github.com/yschimke/compose-ai-tools/commit/a90bda6072547c92a1da6fb065113ba1902219aa))
...
* **preview:** @FocusedPreview(pressed = true) dispatches indirect-pointer Press ([#1585](https://github.com/yschimke/compose-ai-tools/issues/1585)) ([656d686](https://github.com/yschimke/compose-ai-tools/commit/656d6860468a5854ac6ca7f93dbf90dd1374d6db))
...
* **recomposition:** v2 schema with per-scope invalidation reason ([#1612](https://github.com/yschimke/compose-ai-tools/issues/1612)) ([cc0ba18](https://github.com/yschimke/compose-ai-tools/commit/cc0ba18cf019cc306e4ba60ba3e28103c05da111))
...
* **renderer-android:** default LocalInspectionMode to true for static previews ([#1614](https://github.com/yschimke/compose-ai-tools/issues/1614)) ([a0e5102](https://github.com/yschimke/compose-ai-tools/commit/a0e51020582994e2170384de16dc67ebc766b5f0))
...
* **samples:** add :samples:xr-glimmer for Jetpack Compose Glimmer (Android XR) ([#1561](https://github.com/yschimke/compose-ai-tools/issues/1561)) ([e8ffaec](https://github.com/yschimke/compose-ai-tools/commit/e8ffaeca998cba7bd9a5b0704e1de48f5b2c999a))
...
* **samples:** fan GlimmerXrMenuNavigation across all four env backdrops ([#1564](https://github.com/yschimke/compose-ai-tools/issues/1564)) ([9fa4690](https://github.com/yschimke/compose-ai-tools/commit/9fa46907464a480be49dc871d5324c6681e990a9))
* **samples:** interactive XR menu navigation GIF with touchpad gesture overlay ([#1563](https://github.com/yschimke/compose-ai-tools/issues/1563)) ([c7c34f6](https://github.com/yschimke/compose-ai-tools/commit/c7c34f674a29bb678156b12653456dd9e6a4c894))
...
* surface private @Preview methods via reflection ([#1572](https://github.com/yschimke/compose-ai-tools/issues/1572)) ([d0a4219](https://github.com/yschimke/compose-ai-tools/commit/d0a4219762389a0f803eaa60b67810f29f6eaae1))
...
* **tui-cli:** interactive Mosaic-based preview browser ([#1518](https://github.com/yschimke/compose-ai-tools/issues/1518)) ([0cfe0ef](https://github.com/yschimke/compose-ai-tools/commit/0cfe0efe8e7a458923d84e6a300ba4a386a91834))
...
* **xr-glimmer:** real-interaction Default + Focused state captures, enterPlacesFocus opt-in ([#1583](https://github.com/yschimke/compose-ai-tools/issues/1583)) ([6da9155](https://github.com/yschimke/compose-ai-tools/commit/6da915598a8ac4bde5fd4292f4186be07ce5405b))
...
* **a11y:** don't report list items as merged into a scrollable ([#1569](https://github.com/yschimke/compose-ai-tools/issues/1569)) ([9b73218](https://github.com/yschimke/compose-ai-tools/commit/9b73218a0a26c926491ffda45077db73b919afb4))
* **a11y:** preserve baseline findings on ATF-unavailable runs ([#1608](https://github.com/yschimke/compose-ai-tools/issues/1608)) ([b77b21d](https://github.com/yschimke/compose-ai-tools/commit/b77b21d375fb562a2f4083dfe41de58bc38cce95))
* **a11y:** surface only changed previews in PR comment ([#1590](https://github.com/yschimke/compose-ai-tools/issues/1590)) ([be4d46c](https://github.com/yschimke/compose-ai-tools/commit/be4d46cbe896cfdd28b2f1c3d7aae1921f2047f2))
* allow private @Preview Glance composables to be invoked ([#1574](https://github.com/yschimke/compose-ai-tools/issues/1574)) ([35706f7](https://github.com/yschimke/compose-ai-tools/commit/35706f72b7500507fa9dd434b1ed6263216b44a4))
...
* **cli,gradle-plugin:** tighten --variant matching and propagate to doctor ([#1599](https://github.com/yschimke/compose-ai-tools/issues/1599)) ([7c7dc66](https://github.com/yschimke/compose-ai-tools/commit/7c7dc66b844c06dfd822c8a13a29da9f65f2b5c8))
...
* **daemon:** pass classpath via [@argfile](https://github.com/argfile) to avoid spawn E2BIG ([#1621](https://github.com/yschimke/compose-ai-tools/issues/1621)) ([6016418](https://github.com/yschimke/compose-ai-tools/commit/60164187ed33d0fe04b8ec45b38089e7dadf1e61))
...
* **daemon:** truthful supportedOverrides + drop stale Android-only docstrings ([#1603](https://github.com/yschimke/compose-ai-tools/issues/1603)) ([ed8ce55](https://github.com/yschimke/compose-ai-tools/commit/ed8ce55ffce02102af9a0613f0c8b6ac2e3619f4))
...
* discover preview modules without realizing the whole task graph ([#1617](https://github.com/yschimke/compose-ai-tools/issues/1617)) ([2588c6c](https://github.com/yschimke/compose-ai-tools/commit/2588c6cd2ab23004794f468f6a3ee330b3c648f1))
...
* **focus-connector:** release indirect-pointer Press across multi-index captures ([#1589](https://github.com/yschimke/compose-ai-tools/issues/1589)) ([3a7e861](https://github.com/yschimke/compose-ai-tools/commit/3a7e86167588240646bbf1d126a7266e5f6882f0))
...
* **notifications:** distinguish failed renders from removals in PR comment ([#1591](https://github.com/yschimke/compose-ai-tools/issues/1591)) ([465d006](https://github.com/yschimke/compose-ai-tools/commit/465d006f1a7bd3a44e2d19cb150ecc838ef4ff93))
* **notifications:** render @NotificationPreview at 400dp wide, not a 320 square ([#1592](https://github.com/yschimke/compose-ai-tools/issues/1592)) ([02194ad](https://github.com/yschimke/compose-ai-tools/commit/02194adacc4d5434a3df7027c617a040861aa51c))
* **notifications:** treat @PreviewParameter fan-out variants as declared ([#1597](https://github.com/yschimke/compose-ai-tools/issues/1597)) ([b19c3c9](https://github.com/yschimke/compose-ai-tools/commit/b19c3c99d3c7b34432545f3add7312236af7c4d8))
* **permissions:** scope sandbox query bridge by previewId ([#1610](https://github.com/yschimke/compose-ai-tools/issues/1610)) ([34af549](https://github.com/yschimke/compose-ai-tools/commit/34af549181e878953fb1057d83cbf65313745ec9))
...
* **samples:** additively composite Glimmer XR menu so the env shows through ([#1601](https://github.com/yschimke/compose-ai-tools/issues/1601)) ([103d1c5](https://github.com/yschimke/compose-ai-tools/commit/103d1c5d21b8204762d5bf27b5865f343763f2d2))
...
* set explicit notification width to match renderer canvas ([#1576](https://github.com/yschimke/compose-ai-tools/issues/1576)) ([a68c665](https://github.com/yschimke/compose-ai-tools/commit/a68c66590cd5f5018c8abe1b0224f6bc42920445))
...
* **vscode-extension:** address codex follow-ups on preview-tab + focus refresh ([#1598](https://github.com/yschimke/compose-ai-tools/issues/1598)) ([cadcfec](https://github.com/yschimke/compose-ai-tools/commit/cadcfec5c0f9555fe250736be07b0fada2f84ebd))
* **vscode-extension:** clear stale previews when last editor closes ([#1568](https://github.com/yschimke/compose-ai-tools/issues/1568)) ([169166c](https://github.com/yschimke/compose-ai-tools/commit/169166ce53993125ae1227fee51f1011b390eaf4))
* **vscode-extension:** scope bundle overlays to the focused preview ([#1570](https://github.com/yschimke/compose-ai-tools/issues/1570)) ([45a51ec](https://github.com/yschimke/compose-ai-tools/commit/45a51ec3cdfc9c2b91435cf923dda17880a5490a))
