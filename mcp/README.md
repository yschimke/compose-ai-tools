...
[`skills/compose-preview/design/MCP.md`](https://github.com/yschimke/skills/blob/main/skills/compose-preview/design/MCP.md#setup).
...
[`skills/compose-preview/design/MCP.md`](https://github.com/yschimke/skills/blob/main/skills/compose-preview/design/MCP.md);
the PR-review variant (two workspaces, base + head) is
[`skills/compose-preview-review/design/MCP_REVIEW.md`](https://github.com/yschimke/skills/blob/main/skills/compose-preview-review/design/MCP_REVIEW.md).
