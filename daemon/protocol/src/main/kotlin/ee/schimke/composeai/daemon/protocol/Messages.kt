...
//
// The TypeScript counterpart lives in compose-preview-vscode's `src/daemon/`
 ...
 * [`src/daemon/daemonProtocol.ts`](https://github.com/yschimke/compose-preview-vscode/blob/main/src/daemon/daemonProtocol.ts).
 * See [docs/daemon/DATA-PRODUCTS.md](../../../../../../../docs/daemon/DATA-PRODUCTS.md) § "The
