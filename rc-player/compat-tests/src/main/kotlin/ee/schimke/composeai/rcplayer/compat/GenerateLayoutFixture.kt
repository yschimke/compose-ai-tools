...
/** AndroidX-authored browser fixture for component layout and DrawContent ordering. */
public fun main(args: Array<String>) {
  ...
  canvas(buffer, componentId = 11, animationId = 110, width = 54f, height = 58f, 0xffb8f397.toInt())
