# Contributing to `:renderer-desktop-daemon`
...
**Reviewer checklist** for any change under `renderer-desktop-daemon/src/main/`:
...
`Thread.currentThread().interrupt()` under `renderer-desktop-daemon/src/main/`, please justify it in
