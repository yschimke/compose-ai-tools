...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/remote-m3/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/remote-m3/compare.html)**
...
**[▶ Open the Remote Compose Material 3 ↔ M3 Wear OS Apps Design Kit matches (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/remote-m3/matches.html)**
...
| Editable design vectors (figma-svg) | **51** |
| Components with a11y greenlines | **33** |
...
| Renderer | compose-preview 1.38.1-SNAPSHOT |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/remote-m3/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/remote-m3/compare.html) |
| `matches.html` | Cross-system component pairing vs `wear-m3-catalog` — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/compose-ai-tools/blob/design-artifacts/remote-m3/matches.html) |
