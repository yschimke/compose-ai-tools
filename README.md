...
Download `compose-preview-0.3.0.tar.gz` (or `.zip`) from the
[v0.3.0 release](https://github.com/yschimke/compose-ai-tools/releases/tag/v0.3.0)
and put the `bin/` directory on your `PATH`:

```sh
curl -L -o compose-preview.tar.gz \
  https://github.com/yschimke/compose-ai-tools/releases/download/v0.3.0/compose-preview-0.3.0.tar.gz
tar -xzf compose-preview.tar.gz
export PATH="$PWD/compose-preview-0.3.0/bin:$PATH"
...
Download `compose-preview-0.3.0.vsix` from the
[v0.3.0 release](https://github.com/yschimke/compose-ai-tools/releases/tag/v0.3.0)
and install it:
...
`ee.schimke.composeai.preview` version `0.3.0` in your project as shown above.
