...
| Theme | Capture |
| --- | --- |
| `dark` | ![serve-design-page-hover/dark](renders/serve-design-page-hover.dark.png) |
| `light` | ![serve-design-page-hover/light](renders/serve-design-page-hover.light.png) |
...
| Theme | Capture |
| --- | --- |
| `dark` | ![serve-design-page-selected/dark](renders/serve-design-page-selected.dark.png) |
| `light` | ![serve-design-page-selected/light](renders/serve-design-page-selected.light.png) |
...
| Theme | Capture |
| --- | --- |
| `dark` | ![serve-landing-grouped-pages-filtered/dark](renders/serve-landing-grouped-pages-filtered.dark.png) |
| `light` | ![serve-landing-grouped-pages-filtered/light](renders/serve-landing-grouped-pages-filtered.light.png) |

## serve-landing-grouped-pages-pane
...
| Theme | Capture |
| --- | --- |
| `dark` | ![serve-landing-tree-depth/dark](renders/serve-landing-tree-depth.dark.png) |
| `light` | ![serve-landing-tree-depth/light](renders/serve-landing-tree-depth.light.png) |

## serve-landing-tree-depth-component-open
...
| Theme | Capture |
| --- | --- |
| `dark` | ![serve-viewer-motion/dark](renders/serve-viewer-motion.dark.png) |
| `light` | ![serve-viewer-motion/light](renders/serve-viewer-motion.light.png) |

## serve-viewer-motion-motion-lane
...
## serve-viewer-revisions-open

| Theme | Capture |
| --- | --- |
| `dark` | ![serve-viewer-revisions-open/dark](renders/serve-viewer-revisions-open.dark.png) |
| `light` | ![serve-viewer-revisions-open/light](renders/serve-viewer-revisions-open.light.png) |
