...
- **Preview failed/cancelled/skipped**: caller should still invoke the reusable workflow with `if: ${{ always() }}` so it can post a blocked/missing-context comment instead of being skipped.
