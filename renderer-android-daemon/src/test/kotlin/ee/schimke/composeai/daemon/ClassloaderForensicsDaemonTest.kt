 ...
 *
 * Output: `renderer-android-daemon/build/reports/classloader-forensics/daemon.json`. The diff tool
 * (`./gradlew :tools:daemon-harness:dumpClassloaderDiff`) consumes this together with
...
class ClassloaderForensicsDaemonTest {
  ...
  companion object {
     ...
     * `:renderer-daemon-core` because the survey-set is a test-side concern, and promoting would
