...
> sandbox (`--playground-sandbox <unshare|bwrap|systemd|strict|custom:…>`) **and** the startup probe
> proves that jail blocks egress, contains the filesystem, and isolates the process namespace. The
