...
[`NotificationPreviewComposable`](https://github.com/yschimke/compose-preview-daemon/blob/main/renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationPreviewRenderer.kt)
in `:renderer-android`.
...
Implementation: [renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationSidecar.kt](https://github.com/yschimke/compose-preview-daemon/blob/main/renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationSidecar.kt).
...
- [`api/preview-annotations/src/commonMain/kotlin/ee/schimke/composeai/preview/NotificationPreview.kt`](https://github.com/yschimke/compose-preview-daemon/blob/main/api/preview-annotations/src/commonMain/kotlin/ee/schimke/composeai/preview/NotificationPreview.kt) — annotation source.
- [`renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationPreviewRenderer.kt`](https://github.com/yschimke/compose-preview-daemon/blob/main/renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationPreviewRenderer.kt) — renderer entry point.
- [`renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationSidecar.kt`](https://github.com/yschimke/compose-preview-daemon/blob/main/renderers/android/src/main/kotlin/ee/schimke/composeai/renderer/NotificationSidecar.kt) — sidecar schema and writer.
