...
- **Sample fixture:** [[`preview-harness/fixtures/spatial-scene/`](https://github.com/yschimke/compose-preview-vscode/blob/main/preview-harness/fixtures/spatial-scene/)](https://github.com/yschimke/compose-preview-vscode/blob/main/preview-harness/fixtures/spatial-scene/) (`scene.json` + `top.png` / `bottom.png`)
...
[[`src/webview/spatial/`](https://github.com/yschimke/compose-preview-vscode/blob/main/src/webview/spatial/)](https://github.com/yschimke/compose-preview-vscode/blob/main/src/webview/spatial/README.md) — a
