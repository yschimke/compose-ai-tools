...
- [design/RC_CMP_WASM_PLAYER.md](design/RC_CMP_WASM_PLAYER.md) — the non-JVM CMP browser player for Remote Compose documents, including its typed codec, rendering boundaries, conformance gates, and replacement evidence.
