 ...
 * spawns the real `:renderer-android-daemon` `DaemonMain` via [RealAndroidHarnessLauncher] rather
 ...
 * android baseline at `tools/daemon-harness/baselines/android/s1/red-square.png` is captured
